...
train_dataset_with_augementation = RetinopathyLoader('./data', 'train', augmentation=augmentation)
...
print(models["ResNet50(pretrain)"])
# Training & Testing
# name = 'ResNet50'
# Accs[name] = runModels(
#     name, train_dataset_with_augementation, test_dataset, models,
#     epoch_size=10, batch_size=16, learning_rate=1e-3, show=True
# )
# fig = showAccuracy(
#     title=name,
#     **Accs[name]
